...
module CostArrayList refines CostList {
  ...
  class ArrayList<T(0)> extends CostList<T> {
  ...
  class {:ghost} InsertCost<T> extends Cost<InsertIn<T>> {
  ...
  class {:ghost} AppendCost<T> extends Cost<AppendIn<T>> {
  ...
  class {:ghost} OkCost<T> extends Cost<OkIn<T>> {
